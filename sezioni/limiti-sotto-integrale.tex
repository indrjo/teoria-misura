...
\[\liminf_{n \to +\infty} \int_\Omega \abs{f-f_n} \mathrm d \mu \ge \int_\Omega \underbrace{\liminf_{n \to +\infty} \abs{f-f_n}}_{= 0 \text{ per ipotesi}} \mathrm d \mu = 0 . \] E abbiamo concluso, perché il limite inferiore e il limite superiore coincidono.
\end{proof}
